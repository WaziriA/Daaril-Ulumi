...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Weekly Fee Taking Form</div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.weekly_fee.store') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="user_id">Choose Name:</label>
                                        <select id="user_id" name="user_id" class="form-control mt-2">
                                            <option >--- Choose name from the list ----</option>
                        ...
                        <div class="form-group mt-2">
                            <label for="payment_date">Paid For:</label>
