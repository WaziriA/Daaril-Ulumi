...
<div class="card-body pt-3">
    ...
    <div class="tab-content pt-2">
      ...
      <div class="tab-pane fade profile-edit pt-3 card" id="profile-edit">
        ...
        <div class="card-body">
        <!-- Profile Edit Form -->
        <form action="{{route('admin.student_edit.update', $user)}}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="row mb-3">
            <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Profile Image</label>
            <div class="col-md-4 col-lg-6">
              <img src="{{ asset($user->image) }}" alt="Profile" style= "width:250px; height:343px;">
              <div class="pt-2">
